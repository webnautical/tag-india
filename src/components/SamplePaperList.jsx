...
// ── Data — Council wise papers ──
const councilData = {
  "Construction Skill Development Council Of India": [
    { id: 1, title: "Assistant Bar Bender Steel Fixer-L2", pdf: "/papers/bar-bender.pdf" },
    { id: 2, title: "Assistant Construction Painter and Decorator level-2", pdf: "/papers/painter.pdf" },
    { id: 3, title: "Assistant False Ceiling and drywall installer Level-3", pdf: "/papers/ceiling.pdf" },
    { id: 4, title: "Assistant Shuttering Carpenter Level-2", pdf: "/papers/carpenter.pdf" },
    { id: 5, title: "Chargehand Shuttering Carpenter Conventional Level-4", pdf: "/papers/chargehand.pdf" },
  ],
  "Apparel Made-Ups & Home Furnishing Sector Skill Council": [
    { id: 1, title: "Sewing Machine Operator Level-2", pdf: "/papers/sewing.pdf" },
    { id: 2, title: "Fabric Checker Level-3", pdf: "/papers/fabric.pdf" },
    { id: 3, title: "Fashion Designer Level-4", pdf: "/papers/fashion.pdf" },
  ],
  "Domestic Workers Sector Skill Council": [
    { id: 1, title: "General House Keeper Level-2", pdf: "/papers/housekeeper.pdf" },
    { id: 2, title: "Cook Level-3", pdf: "/papers/cook.pdf" },
    { id: 3, title: "Baby Sitter Level-2", pdf: "/papers/babysitter.pdf" },
    { id: 4, title: "Elderly Caretaker Level-3", pdf: "/papers/elderly.pdf" },
  ],
};
...
export default function SamplePaperList() {
  ...
  const papers = councilData[selected] || [];
              ...
              {papers.length > 0 ? (
                ...
                <tr>
                  <td colSpan={9} className="py-12 text-center ">
                    No papers available for this council.
                  </td>
                </tr>
              )}
            </tbody>
